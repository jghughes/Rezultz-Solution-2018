...
namespace RezultzSvc.Clients.Mvc.Mar2023.ClientsUsingHttpRequestService
{
    ...
    /// </summary>
    public class LeaderboardResultsServiceClientMvc : ClientBaseMvc, ILeaderboardResultsServiceClient
	{
		private const string Locus2 = nameof(LeaderboardResultsServiceClientMvc);
		private const string Locus3 = "[RezultzSvc.Clients.Mvc.Mar2023]";

		#region ctor stuff 

		public LeaderboardResultsServiceClientMvc()
		{
			const string failure = "Unable to instantiate LeaderboardResultsServiceClientMvc.";
			const string locus = "[LeaderboardResultsServiceClientMvc]";
