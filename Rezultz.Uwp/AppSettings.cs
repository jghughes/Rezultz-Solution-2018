namespace Rezultz.Uwp
{
    ...
    {
        public static bool MustSelectCategoryOfResultsForSingleParticipantIdOnLaunch { get; set; } = false;
        public static string TargetParticipantIdForSelectedCategoryOfResultsOnLaunch { get; set; } = "95"; //sebastian rojas FragmentInFileNameOfAssociatedProfileFile=119, event #13, Kelso 2022 MTb
        ...
        */
        ...
        public static bool MustUseDraftDataOnLaunch { get; set; } = false; // use this only once, in code behind on landing page
