    ...
    public class ShellViewModel : BindableBase
    {
        ...
        private void OnItemInvoked(NavigationViewItemInvokedEventArgs args)
        {
            if (args.IsSettingsInvoked)
            {
                ...
                //NavigationService.Navigate(typeof(AboutPageViewModel).FullName);
                // changed by Jgh to the name of the page we want to navigate to when Settings icon is clicked 
                return;
            }
