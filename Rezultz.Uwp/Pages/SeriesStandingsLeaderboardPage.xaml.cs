...
{
    public sealed partial class SeriesStandingsLeaderboardPage
    {
        private const string Locus2 = nameof(SeriesStandingsLeaderboardPage);
        private const string Locus3 = "[Rezultz.Uwp]";

        private SeriesStandingsLeaderboardPageViewModel ViewModel => DataContext as SeriesStandingsLeaderboardPageViewModel;
        ...
        public SeriesStandingsLeaderboardPage()
        {
        ...
        protected override async void OnPageHasCompletedLoading(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                GlobalProgressIndicatorVm.OpenProgressIndicator(StringsRezultz.Working + "fetching series standings");
