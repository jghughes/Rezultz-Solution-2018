...
{
    public sealed partial class SingleEventAverageSplitTimesPage
    {
        private const string Locus2 = nameof(SingleEventAverageSplitTimesPage);
        private const string Locus3 = "[Rezultz.Uwp]";

        private SingleEventAverageSplitTimesPageViewModel ViewModel => DataContext as SingleEventAverageSplitTimesPageViewModel;
        ...
        public SingleEventAverageSplitTimesPage()
        {
        ...
        protected override async void OnPageHasCompletedLoading(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                GlobalProgressIndicatorVm.OpenProgressIndicator(StringsRezultz.Working + "fetching average split times");
