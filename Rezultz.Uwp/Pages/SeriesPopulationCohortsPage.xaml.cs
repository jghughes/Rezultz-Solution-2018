...
{
    public sealed partial class SeriesPopulationCohortsPage
    {
        private const string Locus2 = nameof(SeriesPopulationCohortsPage);
        private const string Locus3 = "[Rezultz.Uwp]";

        private SeriesPopulationCohortsPageViewModel ViewModel => DataContext as SeriesPopulationCohortsPageViewModel;
        ...
        public SeriesPopulationCohortsPage()
        {
