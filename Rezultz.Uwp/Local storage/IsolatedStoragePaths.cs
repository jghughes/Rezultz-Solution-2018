...
namespace Rezultz.Uwp.Local_storage
{
    /// <summary>
    /// Provides app-specific paths in isolated storage (not WPF).
    ...
    public class IsolatedStoragePaths : IStorageDirectoryPaths
    {
        ...
        {
            return KindOfInventory; // the only thing needed to uniquely identify this store in isolated storage
        }
        ...
        //{
        //    return string.Empty; // superfluous in isolated storage. its baked in
        //}
        ...
        public string ThisAppName { get; } = @"Rezultz";
