...
namespace NetStd.Exceptions.Mar2024.JghExceptions
{
	...
	[DataContract(Name = "JghAzureRequestException")]
	public class JghAzureRequestException : JghAlertMessageException
	{
		public JghAzureRequestException(string message)
			: base(message)
		{
		}

		public JghAzureRequestException(string message, Exception ex)
			: base(message, ex)
		{
		}
