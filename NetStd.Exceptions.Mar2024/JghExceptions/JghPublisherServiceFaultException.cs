...
namespace NetStd.Exceptions.Mar2024.JghExceptions
{
	/// <inheritdoc />
	/// <summary>
	///     Exception intended as a substitute catchall for data conversion failures.
	...
	[DataContract(Name = "JghPublisherServiceFaultException")]
	public class JghPublisherServiceFaultException : JghAlertMessageException
	{
		public JghPublisherServiceFaultException(string message)
			: base(message)
		{
		}

		public JghPublisherServiceFaultException(string message, Exception ex)
			: base(message, ex)
		{
		}
	}
