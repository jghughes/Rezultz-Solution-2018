...
namespace RezultzSvc.Library02.Mar2024
{
    public static class ConnectionStringRepository
    {
        ...
        public static AzureStorageLocationDto GetPublisherProfileFilesEntryPoint()
        {
            ...
            var answer = new AzureStorageLocationDto
            {
                ...
                AzureStorageContainerName = AzureStorageConnectionStrings.AzureStorageContainerForPublishingModuleProfiles
            };

            return answer;
        }

        public static AzureStorageLocationDto GetExamplesOfInputDatasetsForPublishingEntryPoint()
        {
            // For better security and flexibility this data should not be hard coded.
            // It should be stored in a secure key vault so that no recompilation is required when accounts and/or passwords change. 
            ...
            {
                AzureStorageAccountName = AzureStorageConnectionStrings.AzureStorageAccountOfEntryPointToRezultzDataStorageHierarchy,
                AzureStorageContainerName = AzureStorageConnectionStrings.AzureStorageContainerForExamplesOfDatasetsUsedInPublishingProcess
            };
