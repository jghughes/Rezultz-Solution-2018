...
{
    public sealed partial class TimeStampEntriesInMemoryCacheDataGridPresentationServiceUserControl : ITimeStampEntriesInMemoryCacheDataGridPresentationService
    {
        private object _previouslyTappedItem;

        public TimeStampEntriesInMemoryCacheDataGridPresentationServiceUserControl()
        {
            InitializeComponent();
        }
