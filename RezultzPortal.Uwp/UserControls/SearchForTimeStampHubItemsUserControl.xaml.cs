...
{
    public sealed partial class SearchForTimeStampHubItemsUserControl
    {
        private const string Locus2 = "[SearchForTimeStampHubItemsUserControl]";
        private const string Locus3 = "[RezultzPortal.Uwp]";

        #region ctor

        public SearchForTimeStampHubItemsUserControl()
        {
            InitializeComponent();
        }
