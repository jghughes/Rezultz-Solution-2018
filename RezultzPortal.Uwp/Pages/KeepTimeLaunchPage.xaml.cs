...
{
    public sealed partial class KeepTimeLaunchPage
    {
        private const string Locus2 = nameof(KeepTimeLaunchPage);
        private const string Locus3 = "[RezultzPortal.Uwp]";


        public KeepTimeLaunchPage()
        {
        ...
        protected override void OnNavigatingFrom(NavigatingCancelEventArgs e)
        {
            ...
            //DependencyLocator.DeRegisterITimeStampEntriesInStoragePresentationServiceProvider();
